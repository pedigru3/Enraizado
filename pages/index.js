  ...
  return (
    <>
      <Head>
        ...
        <title>Enraizado - Leia a Bíblia Inteira em 1 Ano | App Cristão</title>
        <meta
          name="description"
          content="Leia a Bíblia inteira em 1 ano com o Enraizado. Apenas 15 minutos por dia para transformar sua vida espiritual. App gratuito com progresso visual e meditações diárias."
        />
        <meta
          name="keywords"
          content="Bíblia, leitura bíblica, Bíblia em 1 ano, app cristão, meditação, espiritualidade, Enraizado, leitura diária, Bíblia completa"
        />
        <meta name="author" content="Enraizado" />
        <meta name="robots" content="index, follow" />
        <meta name="language" content="Portuguese" />
        <meta name="revisit-after" content="7 days" />
        <link rel="canonical" href="https://enraizado.com/" />

        {/* Open Graph para Facebook/LinkedIn */}
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Enraizado - Leia a Bíblia Inteira em 1 Ano"
        />
        <meta
          property="og:description"
          content="Transforme sua vida espiritual lendo a Bíblia completa em 1 ano. Apenas 15 minutos por dia com progresso visual e meditações."
        />
        <meta property="og:url" content="https://enraizado.com/" />
        <meta
          property="og:image"
          content="https://enraizado.com/og-image.jpg"
        />
        ...
        <meta
          ...
          content="Transforme sua vida espiritual lendo a Bíblia completa em 1 ano. Apenas 15 minutos por dia."
        />
        <meta
          name="twitter:image"
          content="https://enraizado.com/twitter-image.jpg"
        />
        ...
        <meta name="apple-mobile-web-app-title" content="Enraizado" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Enraizado",
              description:
                "Aplicativo para leitura bíblica completa em 1 ano. Apenas 15 minutos por dia para transformar sua vida espiritual.",
              ...
              screenshot: "https://enraizado.com/print.webp",
            }),
          }}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://enraizado.com",
              description:
                "Leia a Bíblia inteira em 1 ano com meditações diárias",
              publisher: {
                "@type": "Organization",
                name: "Enraizado",
              },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            >
              <img
                src={logo}
                alt="Logo Enraizado - App para leitura bíblica diária"
      ...
      <main id="main-content">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div
                ...
                ref={addToRefs}
              >
                <span className="inline-block text-black py-1 px-3 rounded-full font-semibold text-sm mb-6 border border-brand-light/30">
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Muitos tentam, mas desistem no caminho. O <b>Enraizado</b>{" "}
                  torna a leitura bíblica simples e constante. Apenas{" "}
              ...
              >
                ...
                >
                  <div className="bg-white mockup-screen-container">
                    ...
                    <img
                      src={mockupImage}
                      alt="Screenshot do App Enraizado mostrando leitura bíblica diária com progresso visual e meditações"
            ...
            <div className="grid md:grid-cols-3 gap-8" id="beneficios">
              ...
              >
                ...
                <p className="text-gray-600">
                  Dividimos a Bíblia em porções diárias perfeitamente
                  calculadas. Você lê no ônibus, no café da manhã ou antes de
                  dormir.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Veja seu &quot;jardim&quot; espiritual crescer à medida que
                  você lê. Acompanhe seu progresso e sinta-se motivado a não
                  quebrar a sequência.
                </p>
              </div>
        ...
        >
          ...
          >
            ...
            >
              Junte-se a milhares de cristãos que estão aprofundando suas
              raízes. Não deixe para amanhã a transformação que pode começar em
              15 minutos.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-3xl inline-block border border-white/20">
              <div className="flex flex-col md:flex-row gap-4">
                <button
                  className="bg-white text-brand-dark px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition shadow-lg flex items-center justify-center gap-2 w-full md:w-auto hover:cursor-pointer"
                  style={{ color: customColors.brandDark }}
                  onClick={() => {
                    window.location.href =
                      "https://play.google.com/store/apps/details?id=com.ferreira.enraizado"
                  }}
                >
                  <svg
                    className="w-6 h-6"
                ...
                <button className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition flex items-center justify-center gap-2 w-full md:w-auto flex-col">
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            <img
              src={logo}
              alt="Logo Enraizado - Aplicativo cristão para leitura bíblica"
